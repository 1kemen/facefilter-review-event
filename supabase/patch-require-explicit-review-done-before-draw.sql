-- Require explicit customer/staff review confirmation before any draw.
-- This removes the old "review link opened + 10 seconds = draw allowed" behavior.
...
begin
  ...
  perform public.ff_write_audit(
    ...
    jsonb_build_object(
      ...
      'reviewGate', 'explicit_review_done'
    )
  );
